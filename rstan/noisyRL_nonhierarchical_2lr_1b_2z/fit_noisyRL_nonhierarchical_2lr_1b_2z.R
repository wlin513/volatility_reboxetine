...
dest_dir<-"/home/wlin/Documents/2019_drug_study/data/rstan/noisyRL_nonhierarchical_2lr_1b_2z"
stan_dir<-"/home/wlin/Documents/2019_drug_study/code/rstan/noisyRL_nonhierarchical_2lr_1b_2z"
fig_dir<-"/home/wlin/Documents/2019_drug_study/tmp_fig/rstan/noisyRL_nonhierarchical_2lr_1b_2z"
...
source(file.path(stan_dir,"read_ests_2lr_1b_2z.R"))
...
fit_bothv <- stan(file = file.path(stan_dir,'noisyRL_nonhierarchical_2lr_1b_2z.stan'), data = stan_data, iter = 4000, chains = 4, control=list(adapt_delta=0.999, max_treedepth = 10))
save(fit_bothv,file=file.path(dest_dir,"noisyRL_nonhierarchical_2lr_1b_2z_bothv.RData"))
#library("shinystan")
...
fit_winv <- stan(file = file.path(stan_dir,'noisyRL_nonhierarchical_2lr_1b_2z.stan'), data = stan_data, iter = 4000, chains = 4, control=list(adapt_delta=0.999, max_treedepth = 10))
save(fit_winv,file=file.path(dest_dir,"noisyRL_nonhierarchical_2lr_1b_2z_winv.RData"))
...
fit_lossv <- stan(file = file.path(stan_dir,'noisyRL_nonhierarchical_2lr_1b_2z.stan'), data = stan_data, iter = 4000, chains = 4, control=list(adapt_delta=0.999, max_treedepth = 10))
save(fit_lossv,file=file.path(dest_dir,"noisyRL_nonhierarchical_2lr_1b_2z_lossv.RData"))
...
fit_boths <- stan(file = file.path(stan_dir,'noisyRL_nonhierarchical_2lr_1b_2z.stan'), data = stan_data, iter = 4000, chains = 4, control=list(adapt_delta=0.999, max_treedepth = 10))
save(fit_boths,file=file.path(dest_dir,"noisyRL_nonhierarchical_2lr_1b_2z_boths.RData"))
...
library(plyr)
library(reshape2)
#load(file=file.path(dest_dir,"noisyRL_nonhierarchical_2lr_1b_2z_lossv.RData"))
IDs=sub('\\/.*',"",subjects$V1)
...
#ggsave("alphas_noisyRL_nonhierarchical_2lr_1b_2z.eps", plot = palpha, device = "eps", path = fig_dir,
...
#ggsave("betas_noisyRL_nonhierarchical_2lr_1b_2z.eps", plot = pbeta, device = "eps", path = fig_dir,
#      scale = 1, width = 20, height = 10, units = "cm",
#      dpi = 300, limitsize = TRUE)
...
library(R.matlab)
#load(file.path(dest_dir,"noisyRL_nonhierarchical_2lr_1b_2z_prescan.RData"))
#load(file.path(dest_dir,"noisyRL_nonhierarchical_2lr_1b_2z_bothv.RData"))
#load(file.path(dest_dir,"noisyRL_nonhierarchical_2lr_1b_2z_winv.RData"))
#load(file.path(dest_dir,"noisyRL_nonhierarchical_2lr_1b_2z_lossv.RData"))
#load(file.path(dest_dir,"noisyRL_nonhierarchical_2lr_1b_2z_boths.RData"))
