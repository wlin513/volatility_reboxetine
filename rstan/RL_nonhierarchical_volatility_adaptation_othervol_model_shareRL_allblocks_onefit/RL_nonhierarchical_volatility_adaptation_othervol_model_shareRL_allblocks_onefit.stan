...
model {
  ...
  for (is in 1:nsub){
   alpha_sta_win_tr[1,is] ~ normal(0,5);
   alpha_sta_loss_tr[1,is] ~ normal(0,5);
   alpha_sta_win_tr[2,is] ~ normal(0,5);
   alpha_sta_loss_tr[2,is] ~ normal(0,5);
   win_vol_adpt_tr[1,is] ~ normal(0,5);
   loss_vol_adpt_tr[1,is] ~ normal(0,5);
   win_vol_adpt_tr[2,is] ~ normal(0,5);
   loss_vol_adpt_tr[2,is] ~ normal(0,5);
