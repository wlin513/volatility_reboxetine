...
subjects<-read.table(file=file.path(data_dir,"rstan_sublist_male_v2_1_2.txt"))
...
save(fit_scandata,file=file.path(dest_dir,"RL_nonhierarchical_volatility_adaptation_othervol_model_shareRL_allblocks_onefit_male_v2_1_2.RData"))
#library("shinystan")
...
library(R.matlab)
writeMat(file.path(dest_dir,'Result_vol_adpt_othervol_model_shareRL_male_v2_1_2.mat'),winalphas=winalphas,lossalphas=lossalphas,betas=betas,win_vol_adpt_tr=win_vol_adpt_tr,loss_vol_adpt_tr=loss_vol_adpt_tr,win_sta_adpt_tr=win_sta_adpt_tr,loss_sta_adpt_tr=loss_sta_adpt_tr)
