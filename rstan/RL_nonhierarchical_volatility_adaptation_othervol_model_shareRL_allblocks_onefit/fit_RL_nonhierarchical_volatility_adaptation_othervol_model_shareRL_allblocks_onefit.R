...
setwd("D:/2019_drug_study/code/rstan")
#where the data files are
data_dir<-"D:/2019_drug_study/data"
dest_dir<-"D:/2019_drug_study/data/rstan/RL_nonhierarchical_volatility_adaptation_othervol_model_shareRL_allblocks_onefit"
stan_dir<-"D:/2019_drug_study/code/rstan/RL_nonhierarchical_volatility_adaptation_othervol_model_shareRL_allblocks_onefit"
fig_dir<-"D:/2019_drug_study/tmp_fig/rstan/RL_nonhierarchical_volatility_adaptation_othervol_model_shareRL_allblocks_onefit"
...
fit_scandata <- stan(file = file.path(stan_dir,'RL_nonhierarchical_volatility_adaptation_othervol_model_shareRL_allblocks_onefit.stan'), data = stan_data, iter = 10000, chains = 4, control=list(adapt_delta=0.99, max_treedepth = 15))
...
# dest_dir<-"D:/2019_drug_study/data/rstan/RL_nonhierarchical_volatility_adaptation_othervol_model_shareRL_allblocks_onefit"
# load(file=file.path(dest_dir,"RL_nonhierarchical_volatility_adaptation_othervol_model_shareRL_allblocks_onefit_exc_2004_iter20k.RData"))
 library("shinystan")
...
library(stringr)
IDs=str_extract(subjects$V1,"(?<=/).*(?=_blk*)")
