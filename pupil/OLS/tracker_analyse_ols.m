...
%                 end
               ...
               des_mat_rew=[ones(size(rew_out_bl,1),1),winsurp,losssurp,winvol,lossvol,winorder,trialnum1];
               des_mat_loss=[ones(size(loss_out_bl,1),1),losssurp,winsurp,lossvol,winvol,lossorder,trialnum1];
...
% 
% saveas(f4,[figdir,'ols_out_EV_block_',strrep(EVs_block{i},'*','_'),'.png'])
% end
% 
...
% %saveas(fall,[figdir,'pupil responses all trials original.png'])
% subplot(4,1,3)
...
% 
% 
% saveas(fbetablock1,[figdir,'ols-',EVs{i},' each block separately.png'])
% end
% 
% 
% %%
...
% plot(range_real*1000,[0 0],'k--') 
% legend('win-received','loss-received')
% saveas(f_all_real,[figdir,'pupil responses all trials real.png'])
% %%
% f_rec_real=figure;
% 
...
% 
% 
% saveas(f_rec_real,[figdir,'pupil response each block separately real.png'])
% %%
% f11=figure;
% 
...
% 
% 
% saveas(f11,[figdir,'pupil response each block separately.png'])
% %%
...
% 
% saveas(fswitchblockreal,[figdir,'pupil response to switch each block separately real.png'])
% 
% %%
...
% 
% 
% saveas(fswitchblock1,[figdir,'pupil response to switch each block separately.png'])
% 
% % nf=figure;
% % hold on;
