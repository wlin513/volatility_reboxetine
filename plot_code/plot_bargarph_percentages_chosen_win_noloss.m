pct_win_notloss_chosen=[squeeze(pct_winchosen.(group{1})(v,:,:)),squeeze(pct_lossnotchosen.(group{1})(v,:,:)),squeeze(pct_winvsloss_chosen.(group{1})(v,:,:))];
...
saveas(f1,[figdir,group{1},'_visit_',num2str(v),'_pct_win_notloss_chosen_result.png'])