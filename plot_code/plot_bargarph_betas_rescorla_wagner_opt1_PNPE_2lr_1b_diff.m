beta_PNPE_2lr_1b_opt1_log=squeeze(log(beta_PNPE_2lr_1b_opt1.(group{1})(2,:,:))-log(beta_PNPE_2lr_1b_opt1.(group{1})(1,:,:)));
...
mean_beta_PNPE_2lr_1b_opt1=mean_beta_PNPE_2lr_1b_opt1_log;
up_beta_PNPE_2lr_1b_opt1=mean_beta_PNPE_2lr_1b_opt1_log+sem_beta_PNPE_2lr_1b_opt1_log;
low_beta_PNPE_2lr_1b_opt1=mean_beta_PNPE_2lr_1b_opt1_log-sem_beta_PNPE_2lr_1b_opt1_log;
...
% end
hold off
title([group{1},': beta visit2 vs visit 1'])
saveas(f,[figdir,group{1},'_beta_diff_result_PNPE_2lr1b_opt1.png'])