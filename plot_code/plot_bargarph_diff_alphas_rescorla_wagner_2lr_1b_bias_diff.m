...
%original space
alpha_rew_2lr_1b_bias_inv_v1=[inv_logit(alpha_rew_2lr_1b_bias.(group{1})(1,:,1))-inv_logit(alpha_rew_2lr_1b_bias.(group{1})(1,:,3));...
    inv_logit(alpha_rew_2lr_1b_bias.(group{1})(1,:,2))-inv_logit(alpha_rew_2lr_1b_bias.(group{1})(1,:,4))];
alpha_rew_2lr_1b_bias_inv_v2=[inv_logit(alpha_rew_2lr_1b_bias.(group{1})(2,:,1))-inv_logit(alpha_rew_2lr_1b_bias.(group{1})(2,:,3));...
    inv_logit(alpha_rew_2lr_1b_bias.(group{1})(2,:,2))-inv_logit(alpha_rew_2lr_1b_bias.(group{1})(2,:,4))];
alpha_rew_2lr_1b_bias_inv=alpha_rew_2lr_1b_bias_inv_v2-alpha_rew_2lr_1b_bias_inv_v1;
...
alpha_loss_2lr_1b_bias_inv_v1=[inv_logit(alpha_loss_2lr_1b_bias.(group{1})(1,:,1))-inv_logit(alpha_loss_2lr_1b_bias.(group{1})(1,:,2));...
    inv_logit(alpha_loss_2lr_1b_bias.(group{1})(1,:,3))-inv_logit(alpha_loss_2lr_1b_bias.(group{1})(1,:,4))];
alpha_loss_2lr_1b_bias_inv_v2=[inv_logit(alpha_loss_2lr_1b_bias.(group{1})(2,:,1))-inv_logit(alpha_loss_2lr_1b_bias.(group{1})(2,:,2));...
    inv_logit(alpha_loss_2lr_1b_bias.(group{1})(2,:,3))-inv_logit(alpha_loss_2lr_1b_bias.(group{1})(2,:,4))];
alpha_loss_2lr_1b_bias_inv=alpha_loss_2lr_1b_bias_inv_v2-alpha_loss_2lr_1b_bias_inv_v1;
...
saveas(f,[figdir,group{1},'_visit2vsvisit1_diff_vol_vs_sta_alpha_result_2lr1b_bias.png'])
