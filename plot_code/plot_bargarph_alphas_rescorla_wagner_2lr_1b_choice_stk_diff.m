...
%original space
alpha_rew_2lr_1b_choice_stickness_inv=squeeze(inv_logit(alpha_rew_2lr_1b_choice_stickness.(group{1})(2,:,:))-inv_logit(alpha_rew_2lr_1b_choice_stickness.(group{1})(1,:,:)));
...
mean_alpha_rew_2lr1b_choice_stickness=mean_alpha_rew_2lr1b_choice_stickness_inv;
up_alpha_rew_2lr1b_choice_stickness=mean_alpha_rew_2lr1b_choice_stickness_inv+sem_alpha_rew_2lr1b_choice_stickness_inv;
low_alpha_rew_2lr1b_choice_stickness=mean_alpha_rew_2lr1b_choice_stickness_inv-sem_alpha_rew_2lr1b_choice_stickness_inv;

alpha_loss_2lr_1b_choice_stickness_inv=squeeze(inv_logit(alpha_loss_2lr_1b_choice_stickness.(group{1})(2,:,:))-inv_logit(alpha_loss_2lr_1b_choice_stickness.(group{1})(1,:,:)));
...
mean_alpha_loss_2lr1b_choice_stickness=mean_alpha_loss_2lr1b_choice_stickness_inv;
up_alpha_loss_2lr1b_choice_stickness=mean_alpha_loss_2lr1b_choice_stickness_inv+sem_alpha_loss_2lr1b_choice_stickness_inv;
low_alpha_loss_2lr1b_choice_stickness=mean_alpha_loss_2lr1b_choice_stickness_inv-sem_alpha_loss_2lr1b_choice_stickness_inv;
...
% end
hold off
title([group{1},':alpha  visit2 - visit1',num2str(v)])
saveas(f,[figdir,group{1},'_alpha_diff_result_2lr1b_choice_stickness.png'])
