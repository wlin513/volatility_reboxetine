...
%original space
alpha_PPE_2lr_2b_inv=squeeze(inv_logit(alpha_PPE_2lr_2b.(group{1})(2,:,:))-inv_logit(alpha_PPE_2lr_2b.(group{1})(1,:,:)));
...
mean_alpha_PPE_2lr2b=mean_alpha_PPE_2lr2b_inv;
up_alpha_PPE_2lr2b=mean_alpha_PPE_2lr2b_inv+sem_alpha_PPE_2lr2b_inv;
low_alpha_PPE_2lr2b=mean_alpha_PPE_2lr2b_inv-sem_alpha_PPE_2lr2b_inv;

alpha_NPE_2lr_2b_inv=squeeze(inv_logit(alpha_NPE_2lr_2b.(group{1})(2,:,:))-inv_logit(alpha_NPE_2lr_2b.(group{1})(1,:,:)));
...
mean_alpha_NPE_2lr2b=mean_alpha_NPE_2lr2b_inv;
up_alpha_NPE_2lr2b=mean_alpha_NPE_2lr2b_inv+sem_alpha_NPE_2lr2b_inv;
low_alpha_NPE_2lr2b=mean_alpha_NPE_2lr2b_inv-sem_alpha_NPE_2lr2b_inv;
...
saveas(f,[figdir,group{1},'_alpha_diff_result_PNPE_2lr2b.png'])
