function plt_2epsilon(epsilon1,epsilon2,group,v,modelname,figdir)
...
%original space
epsilon1_store=squeeze(epsilon1.(group{1})(v,:,:));
...
epsilon2_store=squeeze(epsilon2.(group{1})(v,:,:));
...
saveas(f,[figdir,group{1},'_visit',num2str(v),'_epsilons_model_',modelname,'.png'])
