function plt_2epsilon_dif_winvol(epsilon1,epsilon2,group,modelname,figdir)
condition={'win volatile','win stable'};
...
epsilon1_store=[mean(epsilon1_store1(:,1:2),2),mean(epsilon1_store1(:,3:4),2)];
...
epsilon2_store=[mean(epsilon2_store1(:,1:2),2),mean(epsilon2_store1(:,3:4),2)];
...
saveas(f,[figdir,group{1},'_epsilon_dif_winvol_result_',modelname,'.png'])
