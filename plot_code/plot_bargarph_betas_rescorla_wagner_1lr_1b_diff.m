beta_1lr_1b_log=squeeze(log(beta_1lr_1b.(group{1})(2,:,:))-log(beta_1lr_1b.(group{1})(1,:,:)));
mean_beta_1lr_1b_log=mean(beta_1lr_1b_log,1);
sem_beta_1lr_1b_log=std(beta_1lr_1b_log,1)./sqrt(size(beta_1lr_1b_log,1));
mean_beta_1lr_1b=mean_beta_1lr_1b_log;
up_beta_1lr_1b=mean_beta_1lr_1b_log+sem_beta_1lr_1b_log;
low_beta_1lr_1b=mean_beta_1lr_1b_log-sem_beta_1lr_1b_log;
...
saveas(f,[figdir,group{1},'_beta_diff_result_1lr1b.png'])