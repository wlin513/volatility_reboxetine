...
sem_alpha_rew_2lr1b_inv=std(alpha_rew_2lr_1b_inv,0,2)./sqrt(size(alpha_rew_2lr_1b_inv,1));
...
alpha_loss_2lr_1b_inv=squeeze(inv_logit(alpha_loss_2lr_1b.(group{1})(v,:,:)));
...
saveas(f,[figdir,group{1},'_visit',num2str(v),'_alpha_result_2lr1b.png'])
