...
%original space
beta_rew_2lr_2b_log=squeeze(log(beta_rew_2lr_2b.(group{1})(2,:,:))-log(beta_rew_2lr_2b.(group{1})(1,:,:)));
...
mean_beta_rew_2lr2b=mean_beta_rew_2lr2b_log;
up_beta_rew_2lr2b=mean_beta_rew_2lr2b_log+sem_beta_rew_2lr2b_log;
low_beta_rew_2lr2b=mean_beta_rew_2lr2b_log-sem_beta_rew_2lr2b_log;

beta_loss_2lr_2b_log=squeeze(log(beta_loss_2lr_2b.(group{1})(2,:,:))-log(beta_loss_2lr_2b.(group{1})(1,:,:)));
...
mean_beta_loss_2lr2b=mean_beta_loss_2lr2b_log;
up_beta_loss_2lr2b=mean_beta_loss_2lr2b_log+sem_beta_loss_2lr2b_log;
low_beta_loss_2lr2b=mean_beta_loss_2lr2b_log-sem_beta_loss_2lr2b_log;
...
% end
hold off
title([group{1},':  visit2 - visit1'])
saveas(f,[figdir,group{1},'_beta_diff_result_2lr2b.png'])
