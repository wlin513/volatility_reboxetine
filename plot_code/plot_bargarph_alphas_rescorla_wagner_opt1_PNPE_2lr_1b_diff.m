...
%original space
alpha_PPE_2lr_1b_opt1_inv=squeeze(inv_logit(alpha_PPE_2lr_1b_opt1.(group{1})(2,:,:))-inv_logit(alpha_PPE_2lr_1b_opt1.(group{1})(1,:,:)));
...
mean_alpha_PPE_2lr1b_opt1=mean_alpha_PPE_2lr1b_opt1_inv;
up_alpha_PPE_2lr1b_opt1=mean_alpha_PPE_2lr1b_opt1_inv+sem_alpha_PPE_2lr1b_opt1_inv;
low_alpha_PPE_2lr1b_opt1=mean_alpha_PPE_2lr1b_opt1_inv-sem_alpha_PPE_2lr1b_opt1_inv;

alpha_NPE_2lr_1b_opt1_inv=squeeze(inv_logit(alpha_NPE_2lr_1b_opt1.(group{1})(2,:,:))-inv_logit(alpha_NPE_2lr_1b_opt1.(group{1})(1,:,:)));
...
mean_alpha_NPE_2lr1b_opt1=mean_alpha_NPE_2lr1b_opt1_inv;
up_alpha_NPE_2lr1b_opt1=mean_alpha_NPE_2lr1b_opt1_inv+sem_alpha_NPE_2lr1b_opt1_inv;
low_alpha_NPE_2lr1b_opt1=mean_alpha_NPE_2lr1b_opt1_inv-sem_alpha_NPE_2lr1b_opt1_inv;
...
saveas(f,[figdir,group{1},'_alpha_diff_result_PNPE_2lr1b_opt1.png'])