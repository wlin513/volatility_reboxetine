function plt_1epsilon(epsilon,group,v,modelname,figdir)
blkname={'both volatile','win volatile','loss volatile','both stable'};
epsilon_store=squeeze(epsilon.(group{1})(v,:,:));
...
saveas(f,[figdir,group{1},'_visit',num2str(v),'_epsilon_result_',modelname,'.png'])