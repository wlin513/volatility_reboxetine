beta_2lr_1b_choice_stickness_log=squeeze(log(beta_2lr_1b_choice_stickness.(group{1})(2,:,:))-log(beta_2lr_1b_choice_stickness.(group{1})(1,:,:)));
...
mean_beta_2lr_1b_choice_stickness=mean_beta_2lr_1b_choice_stickness_log;
up_beta_2lr_1b_choice_stickness=mean_beta_2lr_1b_choice_stickness_log+sem_beta_2lr_1b_choice_stickness_log;
low_beta_2lr_1b_choice_stickness=mean_beta_2lr_1b_choice_stickness_log-sem_beta_2lr_1b_choice_stickness_log;
...
saveas(f,[figdir,group{1},'_beta_diff_result_2lr1b_choice_stickness.png'])