...
%original space
alpha_rew_2lr_2b_inv=squeeze(inv_logit(alpha_rew_2lr_2b.(group{1})(v,:,:)));
...
alpha_loss_2lr_2b_inv=squeeze(inv_logit(alpha_loss_2lr_2b.(group{1})(v,:,:)));
...
saveas(f,[figdir,group{1},'_visit',num2str(v),'_alpha_result_2lr2b.png'])
