beta_2lr_1b_bias_log=squeeze(log(beta_2lr_1b_bias.(group{1})(2,:,:))-log(beta_2lr_1b_bias.(group{1})(1,:,:)));
...
mean_beta_2lr_1b_bias=mean_beta_2lr_1b_bias_log;
up_beta_2lr_1b_bias=mean_beta_2lr_1b_bias_log+sem_beta_2lr_1b_bias_log;
low_beta_2lr_1b_bias=mean_beta_2lr_1b_bias_log-sem_beta_2lr_1b_bias_log;
...
saveas(f,[figdir,group{1},'_beta_diff_result_2lr1b_bias.png'])