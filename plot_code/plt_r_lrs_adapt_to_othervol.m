function plt_r_lrs_adapt_to_othervol(modeldata,group,v,modelname,figdir)
%calculate the mean of alpha in logit space and inverse it back to the
%original space
win_lrs_inv=[modeldata.win_vol_adpt_tr.(group{1})(v,:); modeldata.win_sta_adpt_tr.(group{1})(v,:)];
...
loss_lrs_inv=[modeldata.loss_vol_adpt_tr.(group{1})(v,:); modeldata.loss_sta_adpt_tr.(group{1})(v,:)];
